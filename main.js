...
function downloadCardfile() {
	...
	a.href = 'https://heocarnot.github.io/TouHou.github.io/' + selected.value + '.txt'
...
function loadRemoteCardfile() {
	var selected = document.getElementById('cardfiles')
	var url = 'https://heocarnot.github.io/TouHou.github.io/' + selected.value + '.txt'
	var xhr = new XMLHttpRequest();
	xhr.open('get', url, true);
	xhr.onload = function (e) {
		if (xhr.status == 200) {
...
// 自动加载远程excel
readWorkbookFromRemoteFile('https://heocarnot.github.io/TouHou.github.io/角色曲列表.xlsx', function (workbook) {
